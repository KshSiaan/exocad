        ...
        <div className="bg-white rounded-2xl border border-border/60 p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-muted-foreground">Included features</p>
                <p className="text-sm font-semibold text-foreground">
          ...
          <div className="flex flex-wrap gap-3">
            <Button variant="outline" size="sm" className="gap-1.5" asChild>
              <Link href="/subscription?role=designer">
                <RefreshCw size={13} />
                Change Plan
              </Link>
            </Button>
              ...
              canceling ? (
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => { setCanceled(true); setCanceling(false); }}
                  >
                    <XCircle size={12} />
                    Yes, cancel
                  </Button>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-border/60 overflow-hidden">
            <div className="px-5 py-4 border-b border-border/60">
              <p className="text-sm font-bold text-foreground">Billing History</p>
            </div>
